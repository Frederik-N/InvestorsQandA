...
namespace backendTests
{
    public class QuestionsControllerTests
    {
        ...
        public async void GetQuestions_WhenNoParameters_ReturnsAllQuestions()
        {
            ...
            var questionsController = new QuestionsController(mockConfigurationRoot.Object, null, null, null, mockDataRepository.Object);
        ...
        public async void GetQuestions_WhenHaveSearchParameter_ReturnsCorrectQuestions()
        {
            ...
            mockDataRepository
            .Setup(repo =>
            repo.GetQuestionsBySearchWithPagingAsync("Test", 1, 20))
            .Returns(() =>
            ...
            mockConfigurationRoot.Object, null,
            null, null, mockDataRepository.Object);

            var result = await questionsController.getQuestions("Test", false);
            Assert.Single(result);
            mockDataRepository.Verify(mock =>
            mock.GetQuestionsBySearchWithPagingAsync("Test", 1, 20),
            Times.Once());
        }
        ...
        public async void GetQuestion_WhenQuestionNotFound_Returns404()
        {
            ...
            var questionsController = new QuestionsController(mockConfigurationRoot.Object, null, null, mockQuestionCache.Object, mockDataRepository.Object);
